...
# DESHABILITADO: Polla Mundial (Mundial 2026 terminó). Estas dos líneas
# corrían en cada arranque y llenaban los logs con requests a la API.
# Reactivar en la próxima copa descomentando.
