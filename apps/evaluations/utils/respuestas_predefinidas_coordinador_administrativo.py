"""
Respuestas predefinidas y lógica de evaluación para Coordinador Administrativo
...
COMUNICACION_COORD_ADMIN = {
    'pregunta': 'COMUNICACIÓN',
    'respuestas': {
        1: {
            'retroalimentacion': '**Área de mejora crítica:** La comunicación presenta deficiencias graves. Los reportes de inventario son confusos y contienen errores frecuentes. No comunica efectivamente con producción ni ventas. **Acción requerida:** Mejora urgente en comunicación sobre disponibilidad de servicios administrativos.',
            'plan_mejora': 'Participar en taller de comunicación efectiva. Usar plantillas estándar para reportes de inventario. Confirmar comprensión de requerimientos mediante reuniones diarias con otras áreas.'
        },
        2: {
            'retroalimentacion': '**Necesita mejorar:** La comunicación es básica pero insuficiente para el cargo. Los reportes requieren aclaraciones frecuentes. Debe mejorar comunicación con otras áreas sobre disponibilidad de materiales.',
            'plan_mejora': 'Desarrollar habilidades de síntesis en reportes de servicios administrativos. Practicar comunicación clara de faltantes. Mejorar alertas tempranas sobre disponibilidad.'
        },
        3: {
            'retroalimentacion': '**Desempeño aceptable:** Se comunica adecuadamente sobre procesos administrativos. Los reportes son generalmente claros aunque ocasionalmente requieren ajustes. Es receptivo a observaciones. **Oportunidad:** Mayor proactividad en comunicar situaciones críticas de servicios administrativos.',
            'plan_mejora': 'Perfeccionar comunicación de análisis de procesos administrativos complejos. Desarrollar alertas automáticas de servicios administrativos crítico. Comunicar proactivamente desviaciones antes de solicitud.'
        },
        4: {
            'retroalimentacion': '**Buen desempeño:** Comunica efectivamente información de procesos administrativos. Sus reportes son claros, precisos y oportunos. Facilita comprensión de disponibilidad a otras áreas. **Fortaleza reconocida:** Comunicador efectivo.',
            'plan_mejora': 'Mantener excelencia comunicativa. Capacitar al equipo en comunicación efectiva de procesos administrativos. Liderar reuniones de coordinación sobre disponibilidad de materiales.'
        },
        5: {
            'retroalimentacion': '**Desempeño sobresaliente:** Excelente comunicador de información de procesos administrativos. Sus reportes son impecables y anticipan necesidades. Es referente en comunicación sobre disponibilidad y servicios administrativos. **Fortaleza destacada:** Comunicación excepcional.',
            'plan_mejora': 'Mantener excelencia. Crear guías de comunicación de procesos administrativos para el área. Ser mentor en comunicación efectiva de disponibilidad a stakeholders.'
        }
    }
}

TRABAJO_EQUIPO_COORD_ADMIN = {
    'pregunta': 'TRABAJO EN EQUIPO',
    'respuestas': {
        1: {
            'retroalimentacion': '**Área de mejora crítica:** No trabaja efectivamente con producción ni ventas. Se aísla y no comparte información crítica de servicios administrativos. No contribuye a objetivos del área. **Acción requerida:** Desarrollar competencias colaborativas urgentemente.',
            'plan_mejora': 'Participar en actividades de integración con otras áreas. Compartir información de procesos administrativos oportunamente. Colaborar activamente en tomas de inventario trimestral.'
        },
        2: {
            ...
            'plan_mejora': 'Integrarse más con equipos de producción y comercial. Ofrecer información de disponibilidad proactivamente. Compartir mejores prácticas de gestión administrativa.'
        },
        3: {
            ...
            'plan_mejora': 'Liderar iniciativas de mejora en procesos de procesos administrativos. Crear sinergias entre área administrativa, otras áreas. Facilitar comunicación fluida entre áreas.'
        },
        4: {
            'retroalimentacion': '**Buen desempeño:** Trabaja muy bien en equipo. Comparte proactivamente información de servicios administrativos. Coordina efectivamente con otras áreas. Contribuye activamente a objetivos del área. **Fortaleza reconocida:** Excelente colaborador.',
            'plan_mejora': 'Mantener alto nivel de colaboración. Servir como enlace entre área administrativa y áreas productivas. Documentar mejores prácticas de coordinación.'
        },
        5: {
            ...
            'plan_mejora': 'Mantener excelencia. Liderar programa de mejora de coordinación interdepartamental. Facilitar espacios de colaboración entre área administrativa, producción y comercial.'
        }
    }
}

MEJORA_CONTINUA_COORD_ADMIN = {
    ...
    'respuestas': {
        1: {
            ...
            'plan_mejora': 'Capacitación en mejora continua de procesos de inventario. Establecer métricas de calidad para control de servicios administrativos. Proponer al menos una mejora trimestral en procesos.'
        },
        2: {
        ...
        3: {
            'retroalimentacion': '**Desempeño aceptable:** Realiza procesos bajo estándares aceptables. Ocasionalmente propone mejoras. **Oportunidad:** Mayor proactividad en optimización de gestión administrativa.',
            'plan_mejora': 'Liderar proyecto de optimización de proceso específico de procesos administrativos. Proponer automatizaciones en tareas repetitivas. Investigar mejores prácticas de gestión de servicios administrativos.'
        },
        4: {
            'retroalimentacion': '**Buen desempeño:** Compromiso activo con mejora continua. Propone regularmente mejoras en procesos de procesos administrativos. Implementa estándares de calidad altos. **Fortaleza reconocida:** Agente de cambio en el área.',
            'plan_mejora': 'Mantener proactividad. Liderar implementación de mejoras en procesos críticos de procesos administrativos. Formar parte de comité de mejora continua organizacional.'
        },
        5: {
            'retroalimentacion': '**Desempeño sobresaliente:** Excelente en mejora continua. Propone e implementa mejoras significativas constantemente. Ha optimizado procesos clave del área de procesos administrativos. **Fortaleza destacada:** Innovador en gestión de servicios administrativos.',
            'plan_mejora': 'Mantener excelencia. Liderar transformación digital del área de procesos administrativos. Diseñar programa de mejora continua para toda la cadena de suministro.'
        }
    }
}
...
OBJETIVOS_COORD_ADMIN = {
    'pregunta': 'OBJETIVOS - GESTIÓN DE INVENTARIOS',
    'respuestas': {
        1: {
            'retroalimentacion': '**Desempeño insatisfactorio:** No cumple con objetivos de gestión administrativa. Los informes contienen errores graves y frecuentes. No controla órdenes de pedido pendientes. Las asignaciones de recursos no son correctas. No garantiza disponibilidad de servicios administrativos. **Requiere plan de mejora inmediato.**',
            'plan_mejora': 'Capacitación urgente en gestión administrativa y ERP. Supervisión directa en tomas de inventario. Revisión diaria de trabajo por coordinación. Capacitación en control de órdenes de pedido.'
        },
        2: {
            'retroalimentacion': '**Desempeño por debajo de expectativas:** Cumple parcialmente con objetivos. Los informes tienen errores que requieren corrección. El control de procesos administrativos requiere seguimiento constante. Las asignaciones se retrasan. **Necesita mejora significativa.**',
            'plan_mejora': 'Entrenamiento en técnicas de gestión administrativa. Implementar checklist de control de servicios administrativos. Capacitación en asignación de recursos producida. Seguimiento semanal de avances.'
        },
        3: {
            'retroalimentacion': '**Desempeño satisfactorio:** Cumple con objetivos básicos de gestión administrativa. Los informes son generalmente correctos aunque requieren revisión. Controla procesos administrativos adecuadamente. Las asignaciones se entregan a tiempo. **Oportunidad:** Mayor autonomía y proactividad.',
            'plan_mejora': 'Desarrollar análisis de procesos administrativos más profundos. Mejorar precisión en asignaciones para reducir ajustes. Dominar completamente ciclo de órdenes de pedido. Proponer mejoras en procesos.'
        },
        4: {
            'retroalimentacion': '**Buen desempeño:** Cumple muy bien con objetivos. Gestiona efectivamente el ciclo completo de procesos administrativos. Los informes reflejan la realidad del servicios administrativos. Controla órdenes pendientes. Asigna correctamente recursos producida. Garantiza disponibilidad de servicios administrativos. **Fortaleza reconocida:** Confiabilidad en gestión.',
            'plan_mejora': 'Mantener excelencia. Asumir gestión administrativa más complejos. Optimizar procesos de toma trimestral. Participar en proyectos estratégicos del área de operaciones.'
        },
        5: {
            'retroalimentacion': '**Desempeño sobresaliente:** Excelente cumplimiento de objetivos. Su gestión administrativa es impecable. Los informes no presentan errores. Maneja proactivamente todo el ciclo de procesos administrativos. Es referente en gestión de servicios administrativos. **Fortaleza destacada:** Excelencia en gestión administrativa.',
            'plan_mejora': 'Mantener excelencia. Liderar implementación de controles de procesos administrativos. Diseñar modelos de gestión de servicios administrativos para la organización. Optimizar procesos de inventario trimestral.'
        }
    }
}
...
CALIDAD_TRABAJO_COORD_ADMIN = {
    'pregunta': 'CALIDAD EN EL TRABAJO',
    'respuestas': {
        1: {
            'retroalimentacion': '**Área de mejora crítica:** Conocimiento muy limitado del área de procesos administrativos. No analiza aspectos complejos adecuadamente. Los informes presentan errores graves frecuentes. No refleja calidad en el trabajo. **Acción requerida:** Capacitación técnica urgente.',
            'plan_mejora': 'Capacitación intensiva en gestión administrativa. Estudiar procedimientos del área. Supervisión constante en trabajos complejos. Implementar checklist de calidad.'
        },
        2: {
            ...
            'plan_mejora': 'Curso de gestión administrativa. Estudiar casos complejos con mentoría. Implementar revisión sistemática antes de entregar informes. Desarrollar criterio técnico.'
        },
        3: {
            'retroalimentacion': '**Desempeño aceptable:** Amplios conocimientos del área. Analiza adecuadamente situaciones. Los informes son generalmente correctos. **Oportunidad:** Mayor profundidad en análisis complejos de procesos administrativos.',
            'plan_mejora': 'Especializarse en gestión administrativa del sector maderero. Participar en análisis de casos complejos. Mejorar presentación de informes. Desarrollar criterio para discernir situaciones no rutinarias.'
        },
        4: {
            'retroalimentacion': '**Buen desempeño:** Amplios conocimientos del área de procesos administrativos. Analiza efectivamente aspectos complejos. Sus informes son de calidad, presentan pocos errores y reflejan la realidad del servicios administrativos. **Fortaleza reconocida:** Solidez técnica.',
            'plan_mejora': 'Mantener calidad. Profundizar en metodologías avanzadas de procesos administrativos. Ser consultor interno en temas de gestión de servicios administrativos. Participar en proyectos de mejora de calidad del área.'
        },
        5: {
            'retroalimentacion': '**Desempeño sobresaliente:** Amplios y profundos conocimientos de procesos administrativos. Excelente capacidad de análisis de aspectos complejos. Sus informes son impecables y reflejan fielmente la realidad. Es referente técnico. **Fortaleza destacada:** Excelencia técnica.',
            'plan_mejora': 'Mantener excelencia. Liderar capacitación técnica del equipo. Diseñar manuales de procedimientos de procesos administrativos. Representar a la empresa en asuntos técnicos con proveedores externos.'
        }
    }
}

ATENCION_DETALLE_COORD_ADMIN = {
    ...
    'respuestas': {
        ...
        5: {
            ...
            'plan_mejora': 'Mantener excelencia. Liderar implementación de controles de calidad en toda el área. Diseñar programa de certificación en precisión de procesos administrativos. Ser auditor líder interno.'
        }
    }
}

PLANEACION_PROGRAMACION_COORD_ADMIN = {
    ...
    'respuestas': {
        1: {
            ...
            'plan_mejora': 'Capacitación en gestión del tiempo y planeación. Elaborar cronograma semanal de actividades. Usar calendario de procesos administrativos. Coordinar diariamente con equipo y coordinación.'
        },
        2: {
        ...
        3: {
            ...
            'plan_mejora': 'Perfeccionar planeación de procesos administrativos complejos. Implementar seguimiento de hitos críticos. Mejorar coordinación con otras áreas. Desarrollar planes de contingencia.'
        },
        4: {
        ...
        5: {
            ...
            'plan_mejora': 'Mantener excelencia. Liderar planeación estratégica del área de procesos administrativos. Diseñar sistema de gestión de proyectos. Optimizar procesos de inventario trimestral a nivel organizacional.'
        }
    }
}

COMUNICACION_EFECTIVA_COORD_ADMIN = {
    ...
    'respuestas': {
        1: {
            ...
            'plan_mejora': 'Capacitación en comunicación interdepartamental. Implementar reuniones diarias con otras áreas. Establecer protocolo de alertas de servicios administrativos. Desarrollar canales efectivos de comunicación.'
        },
        2: {
            'retroalimentacion': '**Necesita mejorar:** Comunicación limitada con otras áreas. Informa sobre faltantes solo cuando se solicita. No es proactivo en alertas de servicios administrativos. **Recomendación:** Fortalecer comunicación proactiva.',
        ...
        3: {
            'retroalimentacion': '**Desempeño aceptable:** Coordina adecuadamente con otras áreas. Informa sobre disponibilidad cuando es necesario. **Oportunidad:** Mayor proactividad en comunicar situaciones críticas de servicios administrativos.',
        ...
        4: {
            'retroalimentacion': '**Buen desempeño:** Coordina muy bien con otras áreas. Informa oportunamente sobre faltantes o excesos. Previene paros mediante comunicación efectiva. **Fortaleza reconocida:** Comunicación interdepartamental sólida.',
        ...
        5: {
            'retroalimentacion': '**Desempeño sobresaliente:** Excelente comunicación con otras áreas. Coordina magistralmente sobre disponibilidad. Sus alertas previenen paros. Anticipa necesidades. **Fortaleza destacada:** Comunicación excepcional.',
...
ERP_AVANZADO_COORD_ADMIN = {
    ...
    'respuestas': {
        1: {
            ...
            'plan_mejora': 'Curso básico del ERP utilizado. Practicar gestión de OPs y remisiones. Estudiar funcionalidades de procesos administrativos. Tutorías diarias hasta lograr autonomía básica.'
        },
        2: {
        ...
        3: {
            ...
            'plan_mejora': 'Especializarse en módulos avanzados del sistema. Aprender resolución de negativos complejos. Desarrollar consultas personalizadas. Optimizar uso de herramientas de procesos administrativos.'
        },
        4: {
        ...
        5: {
            'retroalimentacion': '**Desempeño sobresaliente:** Experto en ERP. Domina todas las funcionalidades de procesos administrativos. Opera con autonomía total. Resuelve problemas complejos del sistema. Optimiza procesos. **Fortaleza destacada:** Experto en tecnología de procesos administrativos.',
...
GESTION_INVENTARIOS_MADERERO_COORD_ADMIN = {
    'pregunta': 'GESTIÓN DE INVENTARIOS - SECTOR MADERERO',
    'respuestas': {
        1: {
            'retroalimentacion': '**Área de mejora crítica:** No domina metodologías de toma física ni valorización. No entiende variabilidad del producto natural. No aplica criterio para diferenciar errores. Genera problemas en procesos administrativos. **Acción requerida:** Capacitación técnica urgente.',
            'plan_mejora': 'Capacitación en gestión administrativa del sector maderero. Estudiar metodologías de toma física. Aprender valorización por costo promedio. Comprender variabilidad de producto natural.'
        },
        2: {
            'retroalimentacion': '**Necesita mejorar:** Conocimiento básico de gestión administrativa. Aplica toma física con dificultad. No domina valorización. Confunde errores del sistema con variaciones naturales. **Recomendación:** Profundizar conocimientos técnicos.',
            'plan_mejora': 'Curso de gestión administrativa especializados. Estudiar casos del sector maderero. Practicar valorización por costo promedio. Desarrollar criterio técnico.'
        },
        3: {
            ...
            'plan_mejora': 'Especializarse en gestión administrativa del sector. Estudiar casos complejos de variabilidad. Profundizar en políticas de asignación. Participar en actualizaciones metodológicas.'
        },
        4: {
            'retroalimentacion': '**Buen desempeño:** Buen dominio de gestión administrativa del sector maderero. Aplica correctamente metodologías de toma física. Valoriza adecuadamente. Aplica criterio para diferenciar errores de variaciones naturales. **Fortaleza reconocida:** Solidez técnica sectorial.',
            'plan_mejora': 'Mantener dominio. Ser consultor interno en procesos administrativos del sector. Liderar actualización de políticas de procesos administrativos. Capacitar al equipo en especificidades del producto natural.'
        },
        5: {
            'retroalimentacion': '**Desempeño sobresaliente:** Experto en gestión administrativa del sector maderero. Domina todas las metodologías. Aplica criterio excepcional para diferenciar errores de variaciones. Es referente técnico. **Fortaleza destacada:** Experto sectorial.',
            'plan_mejora': 'Mantener excelencia. Liderar implementación de mejores prácticas del sector. Diseñar manual de gestión administrativa madereros. Representar a la empresa en foros técnicos sectoriales.'
        }
    }
}

SOFTWARE_CONTABLE_COORD_ADMIN = {
...
def calcular_puntaje_ponderado_coordinador_administrativo(respuestas):
    """
    Calcula el puntaje ponderado para Coordinador Administrativo
...
def generar_plan_mejora_coordinador_administrativo(respuestas_evaluacion, resultado_evaluacion):
    """
    Genera plan de mejora específico para Coordinador Administrativo
...
"""
    ...
    mapeo_competencias = {
        ...
        9: 'erp_avanzado',
        10: 'gestion_procesos administrativos_maderero',
        11: 'software_contable',
        12: 'plataformas_dian'
    }

    # Mapeo de claves a diccionarios de datos
    RESPUESTAS_COORD_ADMIN = {
        'comunicacion': COMUNICACION_COORD_ADMIN,
        'trabajo_equipo': TRABAJO_EQUIPO_COORD_ADMIN,
        'mejora_continua': MEJORA_CONTINUA_COORD_ADMIN,
        'objetivos': OBJETIVOS_COORD_ADMIN,
        'calidad_trabajo': CALIDAD_TRABAJO_COORD_ADMIN,
        'atencion_detalle': ATENCION_DETALLE_COORD_ADMIN,
        'planeacion_programacion': PLANEACION_PROGRAMACION_COORD_ADMIN,
        'comunicacion_efectiva': COMUNICACION_EFECTIVA_COORD_ADMIN,
        'erp_avanzado': ERP_AVANZADO_COORD_ADMIN,
        'gestion_procesos administrativos_maderero': GESTION_INVENTARIOS_MADERERO_COORD_ADMIN,
        'software_contable': SOFTWARE_CONTABLE_COORD_ADMIN,
        'plataformas_dian': PLATAFORMAS_DIAN_COORD_ADMIN
    }
    ...
    for respuesta in respuestas_evaluacion.order_by('pregunta__orden'):
        ...
        # Si puntuación es 4 o menos: Plan de acción
            ...
            if clave_competencia and clave_competencia in RESPUESTAS_COORD_ADMIN:
                competencia_data = RESPUESTAS_COORD_ADMIN[clave_competencia]
