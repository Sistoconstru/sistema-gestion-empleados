"""
Respuestas predefinidas y lógica de evaluación para Analista de Inventario
...
COMUNICACION_ANALISTA_INVENTARIO = {
...
TRABAJO_EQUIPO_ANALISTA_INVENTARIO = {
...
MEJORA_CONTINUA_ANALISTA_INVENTARIO = {
...
CALIDAD_TRABAJO_ANALISTA_INVENTARIO = {
...
ATENCION_DETALLE_ANALISTA_INVENTARIO = {
...
PLANEACION_PROGRAMACION_ANALISTA_INVENTARIO = {
...
COMUNICACION_EFECTIVA_ANALISTA_INVENTARIO = {
...
ERP_AVANZADO_ANALISTA_INVENTARIO = {
...
GESTION_INVENTARIOS_MADERERO_ANALISTA_INVENTARIO = {
...
SOFTWARE_CONTABLE_ANALISTA_INVENTARIO = {
...
PLATAFORMAS_DIAN_ANALISTA_INVENTARIO = {
...
def calcular_puntaje_ponderado_analista_inventario(respuestas):
    """
    Calcula el puntaje ponderado para Analista de Inventario
...
def generar_plan_mejora_analista_inventario(respuestas_evaluacion, resultado_evaluacion):
    """
    Genera plan de mejora específico para Analista de Inventario
...
"""
    ...
    RESPUESTAS_ANALISTA_INVENTARIO = {
        'comunicacion': COMUNICACION_ANALISTA_INVENTARIO,
        'trabajo_equipo': TRABAJO_EQUIPO_ANALISTA_INVENTARIO,
        'mejora_continua': MEJORA_CONTINUA_ANALISTA_INVENTARIO,
        'objetivos': OBJETIVOS_ANALISTA_INVENTARIO,
        'calidad_trabajo': CALIDAD_TRABAJO_ANALISTA_INVENTARIO,
        'atencion_detalle': ATENCION_DETALLE_ANALISTA_INVENTARIO,
        'planeacion_programacion': PLANEACION_PROGRAMACION_ANALISTA_INVENTARIO,
        'comunicacion_efectiva': COMUNICACION_EFECTIVA_ANALISTA_INVENTARIO,
        'erp_avanzado': ERP_AVANZADO_ANALISTA_INVENTARIO,
        'gestion_inventarios_maderero': GESTION_INVENTARIOS_MADERERO_ANALISTA_INVENTARIO,
        'software_contable': SOFTWARE_CONTABLE_ANALISTA_INVENTARIO,
        'plataformas_dian': PLATAFORMAS_DIAN_ANALISTA_INVENTARIO
    }
    ...
    for respuesta in respuestas_evaluacion.order_by('pregunta__orden'):
        ...
        # Si puntuación es 4 o menos: Plan de acción
            ...
            if clave_competencia and clave_competencia in RESPUESTAS_ANALISTA_INVENTARIO:
                competencia_data = RESPUESTAS_ANALISTA_INVENTARIO[clave_competencia]
